...
function Suzie(){
  ...
  <br/>
		<Breadcrumbs separator=<NavigateNextIcon/>>
  		...
  		<div id="suzieImages">
  			<div id="bigImage">
  				<img alt="picture of BeBoop"width="100%" height="100%" src={require("./Media/beboop.jpg")}/>
  			</div>
  			<div id="smallImages">
      ...
      <div id="suzieText">
  		<h3> About Be Boop </h3>
  		<p> Be Boop is a little shy at first, but once she has settled in she turns into an attentive and purring lap cat. She loves pats and chin tickles and has super soft fur, a fluffy tail, and gorgeous green eyes. We noticed she’s not so sure about men with deep voices, but she can be convinced to trust you if you have plenty of treats on offer.</p>
  		<br/>
      ...
      <Table sx={{ minWidth: 650 }} aria-label="information table about the cat">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="left"><b>BeBoop</b></TableCell>
